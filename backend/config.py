...
SUPABASE_REQUESTS_TABLE = os.getenv("SUPABASE_REQUESTS_TABLE", "maintenance_requests")
SUPABASE_REQUEST_IMPORTS_TABLE = os.getenv("SUPABASE_REQUEST_IMPORTS_TABLE", f"{SUPABASE_REQUESTS_TABLE}_imports")
