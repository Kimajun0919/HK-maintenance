...
| 이미지 파일명 | 설명 | 연결 경로 |
|---|---|---|
| `대량메일_레몬메일_이미지맵_image_20260514.png` | 원본 `기업별 유지보수 팁/인수인계/대량메일_레몬메일 (2)/이미지맵/image.png`에서 복사된 관련 이미지 | `./images/대량메일_레몬메일_이미지맵_image_20260514.png` |

![대량메일_레몬메일_이미지맵_image_20260514](./images/대량메일_레몬메일_이미지맵_image_20260514.png)
